...
for line in hlt_file.readlines():
  ...
  if (line[0:3] == 'HLT'):         # assumes typical lines begin with HLT path name (e.g. HLT_Mu15_v1)
    ...
    process.source = cms.Source("PoolSource",
                                  ...
                                  fileNames = cms.untracked.vstring('/store/mc/RunIISummer16DR80Premix/ZprimeToTT_M-3500_W-35_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/AODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/50000/0C94DCFA-FFB8-E611-AD9D-001E67E6F896.root'
                                  )
                                )
