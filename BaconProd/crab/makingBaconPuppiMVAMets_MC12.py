  ...
  if (line[0:3] == 'HLT'):         # assumes typical lines begin with HLT path name (e.g. HLT_Mu15_v1)
    ...
    process.source = cms.Source("PoolSource",
                                  fileNames = cms.untracked.vstring(
                                    'root://cms-xrd-global.cern.ch//store/mc/RunIISummer16DR80Premix/DsToTau_To3Mu_MuFilter_TuneCUEP8M1_13TeV-pythia8/AODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/00000/0A94F324-9AF7-E711-9C56-02163E01A57E.root',
                                    'root://cms-xrd-global.cern.ch//store/mc/RunIISummer16DR80Premix/DsToTau_To3Mu_MuFilter_TuneCUEP8M1_13TeV-pythia8/AODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/00000/0C091896-15FC-E711-B70D-02163E01353D.root',
                                    'root://cms-xrd-global.cern.ch//store/mc/RunIISummer16DR80Premix/DsToTau_To3Mu_MuFilter_TuneCUEP8M1_13TeV-pythia8/AODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/00000/0C86EC76-EEFA-E711-9923-02163E011E03.root',
                                    'root://cms-xrd-global.cern.ch//store/mc/RunIISummer16DR80Premix/DsToTau_To3Mu_MuFilter_TuneCUEP8M1_13TeV-pythia8/AODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/00000/0E55C9DC-EEFA-E711-8D8D-02163E01A2BD.root',
                                    'root://cms-xrd-global.cern.ch//store/mc/RunIISummer16DR80Premix/DsToTau_To3Mu_MuFilter_TuneCUEP8M1_13TeV-pythia8/AODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/00000/0EB79F34-45FB-E711-B9DE-1CC1DE1CF1F6.root'
                                  )
                                )
...
process.ntupler = cms.EDAnalyzer('NtuplerMod',
                                 ...
                                 outputName    = cms.untracked.string('OutputS2.root'),
