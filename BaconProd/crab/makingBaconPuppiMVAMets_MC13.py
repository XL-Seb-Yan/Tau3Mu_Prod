  ...
  if (line[0:3] == 'HLT'):         # assumes typical lines begin with HLT path name (e.g. HLT_Mu15_v1)
    ...
    process.source = cms.Source("PoolSource",
                                  fileNames = cms.untracked.vstring(
                                     'root://cms-xrd-global.cern.ch//store/mc/RunIISummer16DR80Premix/DsToTau_To3Mu_MuFilter_TuneCUEP8M1_13TeV-pythia8/AODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/00000/149767D2-DBFA-E711-9DB5-02163E011FD7.root',
                                    'root://cms-xrd-global.cern.ch//store/mc/RunIISummer16DR80Premix/DsToTau_To3Mu_MuFilter_TuneCUEP8M1_13TeV-pythia8/AODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/00000/1697B9AA-F5FA-E711-AD73-02163E01353D.root',
                                    'root://cms-xrd-global.cern.ch//store/mc/RunIISummer16DR80Premix/DsToTau_To3Mu_MuFilter_TuneCUEP8M1_13TeV-pythia8/AODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/00000/1A11F8BE-E0FD-E711-BB09-E0071B73B6F0.root',
                                    'root://cms-xrd-global.cern.ch//store/mc/RunIISummer16DR80Premix/DsToTau_To3Mu_MuFilter_TuneCUEP8M1_13TeV-pythia8/AODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/00000/1A92B48A-EEFA-E711-95CB-02163E012A70.root',
                                    'root://cms-xrd-global.cern.ch//store/mc/RunIISummer16DR80Premix/DsToTau_To3Mu_MuFilter_TuneCUEP8M1_13TeV-pythia8/AODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/00000/1EA81216-E7FE-E711-9214-A0369FC5D8F0.root'
                                  )
                                )
...
process.ntupler = cms.EDAnalyzer('NtuplerMod',
                                 ...
                                 outputName    = cms.untracked.string('OutputS3.root'),
    ...
    minTrackPt   = cms.untracked.double(1.2),
    edmTrackName = cms.untracked.string('generalTracks')    
    ),
