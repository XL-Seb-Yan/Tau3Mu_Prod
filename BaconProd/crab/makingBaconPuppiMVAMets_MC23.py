...
for line in hlt_file.readlines():
  ...
  if (line[0:3] == 'HLT'):         # assumes typical lines begin with HLT path name (e.g. HLT_Mu15_v1)
    ...
    process.source = cms.Source("PoolSource",
                                  ...
                                  'root://cms-xrd-global.cern.ch//store/mc/RunIISummer16DR80Premix/DsToPhiPi_ToMuMu_MuFilter_TuneCUEP8M1_13TeV-pythia8/AODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/00000/0A9E880E-A5FA-E711-BEEE-02163E012658.root',
                                    'root://cms-xrd-global.cern.ch//store/mc/RunIISummer16DR80Premix/DsToPhiPi_ToMuMu_MuFilter_TuneCUEP8M1_13TeV-pythia8/AODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/00000/0C974E20-CBF7-E711-A35A-02163E019CBC.root',
                                    'root://cms-xrd-global.cern.ch//store/mc/RunIISummer16DR80Premix/DsToPhiPi_ToMuMu_MuFilter_TuneCUEP8M1_13TeV-pythia8/AODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/00000/0CD22202-A5FA-E711-A131-02163E019E34.root',
                                    'root://cms-xrd-global.cern.ch//store/mc/RunIISummer16DR80Premix/DsToPhiPi_ToMuMu_MuFilter_TuneCUEP8M1_13TeV-pythia8/AODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/00000/0CD3B5B7-95FC-E711-8163-002590E2DD10.root',
                                    'root://cms-xrd-global.cern.ch//store/mc/RunIISummer16DR80Premix/DsToPhiPi_ToMuMu_MuFilter_TuneCUEP8M1_13TeV-pythia8/AODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/00000/0CEDDFAE-A2FA-E711-97F8-02163E0138C0.root'
                                  )
                                )
...
process.ntupler = cms.EDAnalyzer('NtuplerMod',
                                 ...
                                 outputName    = cms.untracked.string('OutputN3.root'),
